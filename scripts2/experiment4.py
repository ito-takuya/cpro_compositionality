#### Experiment 4
# Same as experiment 3, but using 4 logical rule inputs rather than 3 input units
# have an input unit for both, either, notboth, neither separately
# This experiment is to test for whether poor performance of notboth / neither rules is due to the input structure of logic rules in previous experiments
...
import model.task_orig_4logicinputs as task
import time
